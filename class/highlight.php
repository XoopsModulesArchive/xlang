<?php
// $Id: highlight.php,v 1.1 2007/12/25 02:30:27 ohwada Exp $
...
// keyword
	var $_pattern_array;
	var $_replace_callback = 'xlang_highlighter_by_style';

// background-color: light yellow
	var $_style = 'font-weight: bolder; background-color: #ffff80; ';
	var $_class = 'xlang_highlight';
...
// porting from smartsection <http://smartfactory.ca/>
//---------------------------------------------------------
function xlang_highlighter($matches) 
{
// background-color: light yellow
...
function xlang_highlighter_by_style($matches) 
{
	$highlight =& xlang_highlight::getInstance();
...
function xlang_highlighter_by_class($matches) 
{
	$highlight =& xlang_highlight::getInstance();
